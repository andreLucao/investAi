...
// Inline Investment Time Calculator Component
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-gray-100 p-4 rounded-lg flex items-center justify-center text-gray-500">
          Próxima calculadora em desenvolvimento
        </div>
        <div className="bg-gray-100 p-4 rounded-lg flex items-center justify-center text-gray-500">
          Próxima calculadora em desenvolvimento
        </div>
